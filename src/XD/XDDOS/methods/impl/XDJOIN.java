  ...
  implements IMethod
{
  ...
  public void accept(Channel channel, ProxyLoader.Proxy proxy) {
    ...
    channel.writeAndFlush(Unpooled.buffer().writeBytes((new LoginRequest((new StringBuilder()).append(RandomUtils.randomString(8)).append("_PL").toString())).getWrappedPacket()));
